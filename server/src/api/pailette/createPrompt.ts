...
export const createPrompt = (
    ...
    const tokens = {
        ...
        schema: () => `Do not include any explanations, only provide a  RFC8259 compliant JSON response. Do not deviate from this schema. 
        {
            ...
            "colors": [
                {
                    ...
                    "value": "The created color value according to the format.",
